...
namespace CleanCode\Arquitetura\Infra\Indicacao;

use CleanCode\Arquitetura\Dominio\Cpf;
use CleanCode\Arquitetura\Dominio\Indicacao\Indicacao;
use CleanCode\Arquitetura\Dominio\Indicacao\RepositorioDeIndicacao;
